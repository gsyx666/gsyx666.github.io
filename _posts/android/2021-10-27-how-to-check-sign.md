...
![目前看起来很好](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/image-20200119192020020.png)

## 1 使用通用工具去除我们先前的校验

很多人可能不知道，去除简单的签名校验连小朋友都能做到！

![太可怕](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/image-20200119193534667.png)

请看具有「安全性测试」功能的「M* 管理器」上场，一键去除我们上文准备好的受害者的签名校验：

![一键去除签名校验演示](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/killsign.gif)
...
![JADX 打开文件](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/image-20200119200522083.png)

简单对比下可以发现，多了一个「HookApplication」类

![对比代码](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/image-20200119200808336.png)
...
![可以检测出被二改](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/checkApp.gif)
...
![可以检测出被二改](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/earlyCheck.gif)
...
![可以检测出被二改](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/checkProxy.gif)
...
![可以检测出被二改](https://cdn.jsdelivr.net/gh/gtf35/how-to-check-sign/pic/useNewAPICheck.gif)
