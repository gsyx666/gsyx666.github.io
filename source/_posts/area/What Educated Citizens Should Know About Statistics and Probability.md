...
在许多大学中，有相当大比例的专业要求学生修读统计学入门课程。这些学生中的大多数实际上从来不会自己做统计分析。因此，我们应该让他们阅读和理解他人进行的、分析的、发表在期刊上的、由媒体报道的研究。传闻中，观众也以另外两种方式发生了变化。首先，在统计学入门课程中，学生似乎比早期更不擅长定量推理，也许是因为专业代表性更广。而且回流学生较多，他们可能与传统的大学生有不同的兴趣。

毫无疑问，学生可使用的工具在最近几年发生了变化，学院配备了精密的计算器，至少能够计算均值和标准差，而且往往能够完成统计学入门课程中讲授的大部分程序。此外，计算机的普及，Excel等程序具有标准的统计功能。甚至统计软件的使用在过去的几十年中也发生了变化，Minitab和SPSS等程序是菜单驱动的，使新手更容易学习和使用。
...
3. "无效应"或"无差异"与"无效应"之间的差异在统计学上无显著差异，尤其是在使用小样本时。4 .调查中常见的偏倚来源和。
...
参加宗教服务比参加宗教电视或广播更能降低血压。每周参加一次宗教仪式、每天祈祷或学习圣经一次的人，其高血压患病的可能性比每周不去教堂、少祈祷和学习圣经的人低40 % ( Davis 1998 )。
...
_问题1：在公立学校中，你是赞成还是反对创造教学? ( 68 %赞成)。_  
_问题2：你赞成还是反对在公立学校中教授进化论的创世论? ( 40 %赞成)。_
...
_从医学文献中你知道，乳腺X线摄影对恶性肿块的准确率为80 %，对良性肿块的准确率为90 %。也就是说，如果肿块真的是恶性，检测结果80 %的时候会说是恶性，20 %的时候会错误地说是良性。如果肿块真的是良性，那么90 %的时间检测结果会说是恶性，只有10 %的时间会假性宣布为恶性。遗憾的是，您的病人的乳房X线照片是带着肿块是恶性的消息返回的。真正恶性的可能性有多大?_

大部分医师的回答接近75 %。但实际上，在给定概率的情况下，正确答案只占7.5 %左右!埃迪报告说："当被问及这一点时，犯错的医生通常报告说，他们假设癌症的概率，因为病人有阳性的X射线，大约等于癌症患者( 1982年, p . 254)的X射线阳性的概率"。换句话说，医生混淆了女性患有癌症的概率与女性患有癌症的概率。
...
_去年严重的异味问题部分是由于El Ni ~ no [根据某公司]事件在林地地区造成的极端气象条件。她说，Woodland的降雨量是正常降雨量的170 %至180 %。过量降雨意味着蓄水池中的水需要更长的时间才能退出灌溉，从而有更多的时间产生臭味( Goldwitz 1998 )。_

这种推理的问题是，年降雨量是极不稳定的。在加利福尼亚州的戴维斯地区，1951 ~ 1997年以英寸为单位的降雨量的平均值为6.1、12.1、16.7、25.4、37.4。(均值汇总包括低值、第一四分位数、中值、第三四分位数和高值。)该年的降雨量为29.7英寸，在"正常"范围内。cial公司和记者将"平均"与"正常"混为一谈。这种错误在气温和降水数据的报告中非常常见，在其他情况下也是如此。自然可变性的概念对于理解统计结果至关重要，因此在整个入门课程中应该加强自然可变性的概念。

## 10. 总结

本文所讨论的问题构成了统计与概率中一个常见而重要的误解。显然还有其他人，但我发现这些都是如此普遍，以至于数百万人很可能被他们误导。确保我们的学生不在其中，是我们这些教介绍性统计的人的责任。

许多大学现在除了传统的统计学入门课程外，还开设了统计学或数值素养课程，人们可能会认为这些主题属于这些课程而不是传统课程。但这忽略了这一点。如果学生不能阅读报纸上的文章，知道如何进行t检验，并确定假设检验被误用，这有什么好处?

将这篇文章所涉及的话题纳入传统的课程并不困难，事实上，学生只要有好的例子就会听到。对题目2和题目3关于统计显著性与样本量关系的讨论，应该是对类型1和类型2错误讨论的一部分。话题5和话题6可以以概率的方式纳入教学大纲中，并在事实上做出有趣的例证。主题7关于自然可变性作为什么是正常的一部分，可以在课程的早期部分讨论平均值和可变性的度量。

题目1，关于避免基于观察性研究的因果关系的影响，题目4关于调查中的偏见是唯一可能需要补充的大纲。但是我认为重要的是至少简要概述一下统计研究的类型以及是如何做的，这样数据收集过程对学生来说就不是一个完整的谜。一个讲座解释观察性研究和随机实验之间的差异，以及混淆变量在解释观察性研究中的作用比十几次关于统计推断程序的讲座更有助于学生阅读新闻。

本文的重点是帮助学生解释统计研究。那么，那些最终将自己进行研究和数据分析的学生呢？我认为，这些想法对这些学生的学习更加重要。我在许多博士生考试委员会任职，这些学生正在进行各种学科的研究。有两个问题我问每个学生。一个是解释P值的含义。另一个问题是关于复制一项有重要结论的研究，但使用较小的样本量--研究人员惊讶地发现，复制的研究在统计学上没有意义。我要求学生给出可能的解释。我很遗憾地告诉大家，许多学生很难回答这些问题，即使事先告诉他们我将会问他们。当任何一个上过统计课的学生都能回答这些问题以及关于本文主题和相关概念主题的类似问题时，我就知道我们完成了教育公民的使命。
